...
It will run an initial query of Wikidata to get a broad list of American cities. The query becomes more and more specific by asking you yes/no questions and adding to the query string based on the answers given to it so that less and less cities fulfill all the requirements. After 20 questions or once an answer has been found, the bot will guess your city.
